...
CREATE TABLE `rental` (
  ...
  `rental_totalpayed` decimal(7,2) DEFAULT NULL,
...
INSERT INTO `rental` VALUES (16,'2020-04-15 16:00:00','2020-04-16 16:00:00',0,1.00,18,NULL,NULL),(17,'2020-04-14 08:00:00','2020-04-15 16:00:00',1,1.00,18,6,NULL),(22,'2020-04-21 06:00:00','2020-04-22 14:00:00',0,0.02,19,6,NULL),(23,'2020-04-21 12:00:00','2020-04-22 14:00:00',0,0.01,19,6,NULL),(24,'2020-04-21 06:00:00','2020-04-22 15:00:00',0,0.01,19,6,NULL),(25,'2020-04-21 06:00:00','2020-04-21 08:00:00',1,0.01,19,6,NULL),(26,'2020-04-21 08:00:00','2020-04-21 10:00:00',1,0.01,19,6,NULL),(27,'2020-04-21 10:00:00','2020-04-21 12:00:00',1,0.01,19,6,NULL);
...
CREATE TABLE `site_reviews` (
  ...
  `sreview_userid` int(11) DEFAULT NULL,
  `sreview_rating` int(11) DEFAULT NULL,
  `sreview_comment` varchar(250) NOT NULL,
...
INSERT INTO `site_reviews` VALUES (1,NULL,0,'zdaf');
...
CREATE TABLE `user` (
  ...
  `user_walletmoney` decimal(7,2) DEFAULT NULL,
  PRIMARY KEY (`user_id`),
...
INSERT INTO `user` VALUES (2,1,2,'dimit','dimit','',NULL,0,'dimit@d.com','dimit','dimit',NULL,NULL),(3,1,2,'asdasd','asdasd',NULL,NULL,0,'asdasd@s.gr','asdasd','$2a$10$irh7fGlDiYEF/CLvrtmPcej//X1IcB/q9c2i5FSj5E268pcZQM9se',NULL,NULL),(4,1,1,'asdasdasd','sddasdas',NULL,NULL,0,'123456@s.com','123456','$2a$10$EwgOUkgj82kydX7stUoB.uKesTtT.AfrV44EbzNpLcTBduCDGGyNy',NULL,NULL),(5,1,1,'afasdgfasgas','asdgasdgasdg',NULL,NULL,0,'asdgasga@asd.com','afasdfasfdasdfads','$2a$10$DH.D.D.ltQkf793nDcB8beWbRWn/jDC1lpPD2tZ/bgP456nSt9dE.',NULL,NULL),(6,3,1,'admin','admin','sb-5li9g1605065@personal.example.com',NULL,3,'admin@admin.com','admin','$2a$10$L0xTGX5oaCVPglc9nWIMqOh0kbHabTWzA36CvrjsRt5uWzNYp.5am',NULL,1500.00),(7,1,1,'asdasdasd','asdasdasd',NULL,NULL,0,'asdasdasd@asdasd.com','asdasdasd','$2a$10$nUZE2DceIDXxL0enebw6G.9H9xAdcEF2q3.aKhmPwy0ahljgH6Rhe',NULL,NULL),(8,1,1,'admin','admin',NULL,NULL,0,'admin2@aga.com','admin2','$2a$10$aQkVKQMQD.XqLyqLTRzBZOqF4gFyKJyLw52hLdZ4p4WbiuSfTr.Ku',NULL,NULL),(9,1,1,'admine','admine',NULL,NULL,0,'afasdf@asdas.com','admin3','$2a$10$LHDZCWJIHNw7w03T.6NLzuRjZMh0VDiCKre8CiW4HedxAR9EAfcX2',NULL,NULL),(10,1,1,'dimtry','dimtry','sb-tja4w1606223@business.example.com',NULL,0,'dimitristryf@gmail.com','dimtry','$2a$10$voiy/LSNO1RvKFFiXPmqV.LPE63BWC1JyGhCYcwJYAOgXI9bSNQgW',NULL,NULL),(11,1,1,'Kostas','VLachos',NULL,NULL,0,'kostas_deck@hotmail.com','kmvkos','$2a$10$.vK9AoL1fnH9Rbt.8w/i/uZTMrjMZRsG61Es6/VdnJyFEIXnK7d4m',NULL,NULL),(12,1,1,'Kosats','Vlachos',NULL,NULL,0,'kostas_deck@hotmail.com','kmbkod12','$2a$10$E/HoYjQIogctncgGYV87.e726SxN80TeVijx/TseTtDdIimu.2tLm',NULL,NULL),(13,2,1,'dim','try',NULL,NULL,0,'j0e1992@hotmail.com','dim111','$2a$10$LO3Ar4pjeldCx.yxcCKf1O6B1AP3O7TwcQEh/MuiZgYLIdg5VYNMu','dxqZyNuFAR',NULL),(14,2,2,'master','master',NULL,NULL,0,'master@master.com','master','$2a$10$spkrkvkrqmCGPZeSZCUdtOMxjDSqGcGum.lgdb1LlDWsfhfp7yWP.','iPyVLQOe10',NULL);
...
-- Dump completed on 2020-04-29 21:16:20
